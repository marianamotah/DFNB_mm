...
SELECT TOP 5 YEAR(soh.OrderDate) AS Orderdateyear, p.ProductID, p.Name AS ProductName , p.ProductNumber, p.Color, COUNT(sod.SalesOrderID) AS SalesOrderID
, SUM(sod.OrderQty) AS OrderQuantit , SUM(sod.LineTotal) AS LineTotal
